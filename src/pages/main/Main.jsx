					...
					<div className='main-intro-stats-2 flex flex-wrap gap-4'>
						...
						<div className='flex w-full items-center gap-4 mobile:gap-4 mobile:flex-row-reverse mobile:justify-end'>
							...
							<div className='relative flex w-[5.1rem] h-[2.2rem] mobile:h-[2.7rem] items-center'>
								<img src='./assets/user_1.jpg' alt='User image example 1' className='h-[2.2rem] mobile:h-[2.7rem] rounded border-[0.1rem] mobile:border-[0.15rem] border-white absolute left-0 z-30'/>
								<img src='./assets/user_2.jpg' alt='User image example 2' className='h-[2.2rem] mobile:h-[2.7rem] rounded border-[0.1rem] mobile:border-[0.15rem] border-white absolute left-6 z-20'/>
								<img src='./assets/user_3.jpg' alt='User image example 3' className='h-[2.2rem] mobile:h-[2.7rem] rounded border-[0.1rem] mobile:border-[0.15rem] border-white absolute left-12 z-10'/>
							</div>
