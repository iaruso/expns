  ...
  return (
    <nav className='w-full flex items-center justify-between h-12 mobile:h-16 p-2 gap-2 md:border-[0.05rem] mobile:border-b-[0.1rem] md:rounded-lg border-gallery bg-white'>
      ...
      <div className='flex items-center gap-1 px-2 h-8 mobile:h-10 border-x-[0.05rem] mobile:border-x-[0.1rem] border-gallery'>
        <button className='h-8 w-8 mobile:h-10 mobile:w-10 flex items-center justify-center rounded bg-royal hover:bg-persian hover:duration-200'>
