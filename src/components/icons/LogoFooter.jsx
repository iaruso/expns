  ...
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" width='24' height='24'>
      <g clipPath="url(#clip0_236_1334)">
        ...
        <path d="M10 0H6C2.68629 0 0 2.68629 0 6V10C0 13.3137 2.68629 16 6 16H10C13.3137 16 16 13.3137 16 10V6C16 2.68629 13.3137 0 10 0Z" fill="#EAEAEA"/>
        <path d="M26 16H22C18.6863 16 16 18.6863 16 22V26C16 29.3137 18.6863 32 22 32H26C29.3137 32 32 29.3137 32 26V22C32 18.6863 29.3137 16 26 16Z" fill="#EAEAEA"/>
      </g>
    </svg>
