...
const TransactionItem = ({ id, name, date, value, category, type, currency, localCurrency, currencyRates, setEditFormData }) => {
  ...
  return (
    <div className='h-8 w-full flex items-center gap-1 py-1 px-2 hover:bg-alabaster hover:duration-[0.4s] ease-in-out cursor-pointer' data-id={id} onClick={handleEditClick}>
